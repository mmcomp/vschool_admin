              ...
              <div class="col-xs-12">
                  <div class="box">
                      <div class="box-header">
                          <h3 class="box-title">سطوح</h3>
                          <a class="btn btn-primary pull-left" href="/userlevels/create">ثبت سطح</a>
                      </div><!-- /.box-header -->
                      <div class="box-body">
                          <table id="example2" class="table table-bordered table-hover table-striped" data-page-length='20'>
                              ...
                              @foreach($levels as $i=>$level)
                                <tr>
                                  ...
                                  <td>{{ $level->max_exp }}</td>
                                  <td>
                                    <a class="btn btn-success" href="/userlevels/edit/{{ $level->id }}">
                                    ویرایش
                                    </a>
                                    <a class="btn btn-danger btn-delete" href="/userlevels/delete/{{ $level->id }}">
                                    حذف
                                    </a>
                                  </td>
                                </tr>
