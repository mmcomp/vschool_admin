  ...
  <div class="content-wrapper" style="background: url('/admin/dist/img/mashhad.png');">
      ...
      <section class="content-header">
          <h1 style="background-color: #ffffff;padding: 10px;">
            مدیریت دسته بندی شهروندان
              <small>Resident Catagories</small>
          </h1>
      </section>
              ...
              <div class="col-xs-12">
                  <div class="box">
                      <div class="box-header">
                          <h3 class="box-title">دسته بندی شهروندان</h3>
                          <a class="btn btn-primary pull-left" href="/resident_catagories/create">ثبت دسته</a>
                      </div><!-- /.box-header -->
                      <div class="box-body">
                          <table id="example2" class="table table-bordered table-hover table-striped" data-page-length='20'>
                              ...
                              <tbody>
                              @foreach($rcats as $i=>$rcat)
                                <tr>
                                  <td>{{ $i + 1 }}</td>
                                  <td>{{ $rcat->name }}</td>
                                  <td>
                                    <a class="btn btn-success" href="/resident_catagories/edit/{{ $rcat->id }}">
                                    ویرایش
                                    </a>
                                    <a class="btn btn-danger btn-delete" href="/resident_catagories/delete/{{ $rcat->id }}">
                                    حذف
                                    </a>
                                  </td>
                                </tr>
