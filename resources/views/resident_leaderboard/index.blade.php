...
<div class="content-wrapper" style="background: url('/admin/dist/img/koohsangi.jpg');">
    ...
    <section class="content-header" style="background-color: #ffffff;padding: 10px;">
        <h1>
            جدول رده بندی شهروندی
        </h1>
    </section>

    <!-- Main content -->
    <section class="content">
        @if($resident->show_in_leaderboard==0)
        <div class="row">
            <div class="col-md-12 prvc" style="background-color: #fff;padding: 10px;text-align: center;">
                برای دیدن رتبه شهروندان دیگر در جدول رده بندی باید مجوز دیده شدن خود را بدهید
            </div><!-- /.col -->
            <div class="col-md-6 prvc" style="background-color: #fff;padding: 10px;text-align: center;">
                <a href="/resident_leaderboard/accept_privecy" class="btn btn-success">
                    موافقم
                </a>
            </div>
            <div class="col-md-6 prvc" style="background-color: #fff;padding: 10px;text-align: center;">
                <a href="#" onclick="return hidePrvc();" class="btn btn-danger">
                    مخالفم
                </a>
            </div>
        </div><!-- /.row -->
                        ...
                        <table id="example2" class="table table-bordered table-hover table-striped"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @endif
                                    <td>{{ $theResident->residet_experience }}</td>
                                </tr>
                                @endforeach
                                @php
                                $indx = count($tops);
