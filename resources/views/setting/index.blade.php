              ...
              <div class="col-xs-12">
                  <div class="box">
                      <div class="box-header">
                          ...
                          <!-- <a class="btn btn-primary pull-left" href="/level/create">ثبت لول</a> -->
                      </div><!-- /.box-header -->
                      <div class="box-body">
                          <table id="example2" class="table table-bordered table-hover table-striped" data-page-length='20'>
                              ...
                              @foreach($settings as $i=>$setting)
                                <tr>
                                  ...
                                  <td>{{ $setting->value }}</td>
                                  <td>
                                    <a class="btn btn-success" href="/setting/edit/{{ $setting->id }}">
                                    ویرایش
                                    </a>
                                    <!-- <a class="btn btn-danger btn-delete" href="/setting/delete/{{ $setting->id }}">
                                    حذف
                                    </a> -->
                                  </td>
                                </tr>
