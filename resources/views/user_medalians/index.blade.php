              ...
              <div class="col-xs-12">
                  <div class="box">
                      <div class="box-header">
                          ...
                          <a class="btn btn-primary pull-left" href="/user_medalians/create">ثبت نشان</a>
                      </div><!-- /.box-header -->
                      <div class="box-body">
                          <table id="example2" class="table table-bordered table-hover table-striped" data-page-length='20'>
                              ...
                              <tbody>
                              @foreach($medalians as $i=>$medalian)
                                <tr>
                                  <td>{{ $i + 1 }}</td>
                                  <td>{{ $medalian->name }}</td>
                                  <td>{{ $medalian->min_exp }}</td>
                                  <td>{{ $medalian->code }}</td>
                                  <td>
                                    <a class="btn btn-success" href="/user_medalians/edit/{{ $medalian->id }}">
                                    ویرایش
                                    </a>
                                    <a class="btn btn-danger btn-delete" href="/user_medalians/delete/{{ $medalian->id }}">
                                    حذف
                                    </a>
                                  </td>
                                </tr>
